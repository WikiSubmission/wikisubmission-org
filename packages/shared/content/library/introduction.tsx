/**
 * Full text of the Introduction to Quran: The Final Testament, shared by the
...
import { ChevronLeft, FileText, Download, ArrowUpRight, BookOpen } from 'lucide-react'
  ...
  return (
    <blockquote className="group relative my-5 overflow-hidden rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/70 p-5 sm:p-6 space-y-3.5 shadow-sm transition-all duration-300 hover:border-[var(--ed-accent)]/50">
      <div className="flex items-center gap-2.5">
        <span className="relative flex size-2 shrink-0 items-center justify-center rounded-full bg-[var(--ed-accent)]"><span className="absolute size-3.5 rounded-full border border-[var(--ed-accent)]/25" /></span>
        <span
...
function WorldPopulationBar() {
  return (
    <figure className="my-2 space-y-2.5 rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/55 p-4 shadow-sm sm:p-5">
      <div className="relative h-12 rounded-xl overflow-hidden flex border border-[var(--ed-rule)]">
        {/* Small dark section: population since Adam (~5%) */}
        <div className="bg-[var(--ed-fg)] shrink-0 transition-all" style={{ width: '5%' }} />
        {/* Large lighter section: population from 1989 to 2280 */}
        <div className="flex-1 bg-[var(--ed-surface)]/90 flex justify-center flex-row items-center px-4">
          <span
            className="text-xs sm:text-sm text-[var(--ed-fg)] font-medium leading-tight text-center"
            style={{ fontFamily: F.glacial }}
          >
      ...
      <figcaption
        className="text-center text-[11px] italic leading-relaxed text-[var(--ed-fg-muted)] sm:text-left"
        style={{ fontFamily: F.serif }}
      >
...
function AngelsRatioBars() {
  const smallPct = 8
  return (
    <figure className="my-2 rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/55 p-4 shadow-sm sm:p-5">
      {/* Top bar */}
      <div className="relative h-14 rounded-t-xl overflow-hidden flex border border-[var(--ed-rule)]">
        <div className="flex-1 bg-[var(--ed-surface)] border-r flex-row justify-center border-[var(--ed-rule)] flex items-center px-4">
          <span
            className="text-xs sm:text-sm text-[var(--ed-fg)] leading-tight text-center"
            style={{ fontFamily: F.glacial }}
          >
        ...
        <div
          className="shrink-0 bg-[var(--ed-fg)]/30"
      ...
      <div className="relative h-8 overflow-visible">
        ...
        >
          <line
            ...
            strokeWidth="1"
            strokeDasharray="3 3"
            className="text-[var(--ed-accent)] opacity-50"
          />
          <line
            x1="100%"
            y1="0%"
      ...
      <div className="relative h-14 rounded-b-xl overflow-hidden flex border border-[var(--ed-rule)]">
        <div className="flex-1 bg-[var(--ed-surface)]/70 border-r flex-row justify-center border-[var(--ed-rule)] flex items-center px-4">
          <span
            className="text-xs sm:text-sm text-[var(--ed-fg)] leading-tight text-center"
            style={{ fontFamily: F.glacial }}
          >
        ...
        <div
          className="shrink-0 bg-[var(--ed-fg)]/60"
          style={{ width: `${smallPct}%` }}
        />
      </div>
    </figure>
    ...
    <article className="mx-auto max-w-3xl space-y-6 sm:space-y-8">
      ...
      <header className="space-y-6 text-center pt-2 pb-10 sm:pb-12 border-b border-[var(--ed-rule)]">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[var(--ed-rule)] bg-[var(--ed-surface)]/80 shadow-2xs backdrop-blur-sm">
          <BookOpen size={13} className="text-[var(--ed-accent)]" />
          <span
        ...
        {/* Title */}
        <h1
          className="text-5xl sm:text-6xl md:text-7xl font-medium tracking-tight sm:tracking-[-0.03em] leading-[0.95] text-[var(--ed-fg)]"
          style={{ fontFamily: F.display }}
        >
          Introduction
        </h1>

        {/* Sacred Basmalah: Arabic & English */}
        <div className="space-y-2 pt-1">
          <p
            className="text-2xl sm:text-3xl text-[var(--ed-accent)] font-normal tracking-wide"
          ...
          <p
            className="text-base sm:text-lg text-[var(--ed-fg-muted)] italic"
            style={{ fontFamily: F.serif }}
          >
      ...
      {/* ── The Four Categories ────────────────────────────────────────── */}
      <SectionDivider label="The Four Categories of Creatures" />
      ...
      >
        ...
        {/* (1) The Angels */}
        <div className="group relative overflow-hidden rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/50 p-5 sm:p-6 space-y-3.5 shadow-sm transition-all duration-300 hover:border-[var(--ed-accent)]/30">
          <h3
            className="text-[1.4rem] font-medium tracking-[-0.02em] text-[var(--ed-accent)] sm:text-2xl"
            style={{ fontFamily: F.display }}
          >
            (1) The Angels
          </h3>
        ...
        <div className="group relative overflow-hidden rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/50 p-5 sm:p-6 space-y-3.5 shadow-sm transition-all duration-300 hover:border-[var(--ed-accent)]/30">
          ...
          <div
            data-card
            className="space-y-2.5 rounded-[1.1rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/90 p-4 sm:p-5 text-center text-sm italic text-[var(--ed-fg)] shadow-sm"
          >
            <p>
      ...
      <div
        data-card
        className="rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/70 p-5 sm:p-6 space-y-4 shadow-sm"
      >
        <div className="flex flex-wrap items-center justify-between gap-2.5">
          ...
          <span className="rounded-full border border-[var(--ed-rule)] px-2.5 py-0.5 text-[10px] text-[var(--ed-fg-muted)]">
            Verified by the Reader
          </span>
        </div>

        <section
          className="space-y-4 text-base leading-[1.8] text-[var(--ed-fg)]/90 sm:text-[17px]"
          style={{ fontFamily: F.serif }}
        >
          <p>
        ...
        <div className="grid grid-cols-1 gap-3 border-t border-[var(--ed-rule)]/60 pt-4 sm:grid-cols-2">
          <div className="group rounded-[1.1rem] border border-[var(--ed-rule)] bg-[var(--ed-bg)] p-4 space-y-2 transition-all duration-300 hover:border-[var(--ed-accent)]/40">
            <span
              className="block text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--ed-fg-muted)]"
              style={{ fontFamily: F.glacial }}
            >
              Total count of word &ldquo;God&rdquo;
            </span>
            <span
              className="block text-xl sm:text-2xl font-bold tabular-nums tracking-tight text-[var(--ed-accent)]"
              style={{ fontFamily: F.mono }}
            >
              2698 (19 × 142)
            </span>
            <span className="text-[11px] text-[var(--ed-fg-muted)]/70 block">
              Lower left corner of every page
            </span>
          </div>
      ...
      <section className="space-y-4">
        <p
          className="max-w-2xl text-base font-medium leading-[1.8] text-[var(--ed-fg)] sm:text-[17px]"
          style={{ fontFamily: F.serif }}
        >
        ...
        <ol className="space-y-2.5 text-base leading-[1.75] text-[var(--ed-fg)]/90 sm:text-[17px]">
          {(
            [
              {
            ...
            <li
              key={i}
              className="group flex items-start gap-3.5 rounded-[1.1rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/40 p-3.5 sm:p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-[var(--ed-accent)]/40 hover:bg-[var(--ed-surface)]/70"
            >
              <span
                className="mt-0.5 flex size-6 sm:size-7 shrink-0 items-center justify-center rounded-full border border-[var(--ed-accent)]/25 bg-[var(--ed-accent-soft)]/15 text-[10px] font-bold text-[var(--ed-accent)]"
                style={{ fontFamily: F.mono }}
              >
                {i + 1}
              </span>
      ...
      >
        ...
        {/* Ben Baz Quote Box */}
        <div className="rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/70 p-5 sm:p-6 space-y-4 shadow-sm">
          {/* Original Arabic scan — landscape */}
          <div className="overflow-hidden rounded-[1.05rem] border border-[var(--ed-rule)] bg-[var(--ed-bg)] p-2 shadow-inner">
            <Image
          ...
          <div className="space-y-3">
            <p
              className="border-l-2 border-[var(--ed-accent)]/55 pl-4 text-base italic leading-[1.8] text-[var(--ed-fg)] sm:text-[17px]"
              style={{ fontFamily: F.serif }}
            >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-[var(--ed-rule)]/40 pt-2.5">
              <p
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full border border-[var(--ed-accent)]/25 bg-[var(--ed-accent-soft)]/10 px-3 py-1 text-[11px] font-semibold text-[var(--ed-accent)] transition-all hover:border-[var(--ed-accent)] hover:bg-[var(--ed-accent-soft)]/20"
                style={{ fontFamily: F.glacial }}
              >
                <FileText className="size-3.5" />
                <span>Source, page 11, left side</span>
      ...
      <div
        data-card
        className="relative overflow-hidden rounded-[1.25rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/70 p-5 sm:p-6 text-center shadow-sm space-y-2.5"
      >
        <p
          className="text-base sm:text-lg italic leading-[1.8] text-[var(--ed-fg)]"
          style={{ fontFamily: F.serif }}
        >
          &ldquo;Absolutely, God&apos;s allies will have nothing to fear, nor will
          ...
          God&apos;s inviolable law. This is the true triumph.&rdquo;
        </p>
        <p
      ...
      >
        <p
          className="text-base leading-[1.8] text-[var(--ed-fg)] sm:text-[17px]"
          style={{ fontFamily: F.serif }}
        >
          &ldquo;Surely, those who believe, those who are Jewish, the Christians,
      ...
      <div className="space-y-5 border-t border-[var(--ed-rule)] pt-6">
        ...
        <div className="rounded-[1.1rem] border border-[var(--ed-rule)] bg-[var(--ed-surface)]/50 p-4 sm:p-5">
          <p
            className="text-xs leading-[1.75] text-[var(--ed-fg-muted)] sm:text-sm"
            style={{ fontFamily: F.serif }}
          >
