    ...
    <>
      ...
      <section className="space-y-5 text-base leading-relaxed text-foreground/90">
        <p>
          ...
          of the eighties, even parents start talking about boyfriends for their daughters and
        ...
        <p>
          ...
          these flagrant violations of God&apos;s law cost them a lot of misery and problems (
