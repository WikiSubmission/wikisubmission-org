                ...
                <div className="flex justify-center">
                  <TabsList className="bg-secondary/50 p-1 overflow-x-auto no-scrollbar">
                    {qCount > 0 && (
                      <TabsTrigger
                        value="quran"
                        className="flex-1 md:flex-initial px-3 md:px-4 h-full flex items-center gap-1.5 md:gap-2 justify-center"
                      >
  ...
  return (
    <div className="space-y-4 pt-8 animate-pulse">
      {[1, 2, 3].map((i) => (
        <div
          key={i}
          className="md:flex gap-6 items-start p-4 bg-muted/30 rounded-2xl"
        >
        ...
        <div className="space-y-3 flex-1 min-w-0">
          ...
          <div className="space-y-3">
            {items.map((item, idx) => (
              <div
                key={idx}
                className="text-sm text-muted-foreground/80 group/match transition-colors"
              >
