        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-2">
              ...
              10 years after we post such revised Terms (indicated by revising
              the date at the top of these Terms) or upon your acceptance if we
              ...
              It is your responsibility to check our website for changes to
              these Terms.
            </p>
            <p className="text-sm text-muted-foreground">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              party&apos;s own terms of service or privacy policies. We
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-2">
              ...
              for some period of time. We will retain web server access logs for
              a maximum of 1 year and then delete them.
            </p>
            <p className="text-sm text-muted-foreground mb-2">
          ...
          <div>
            ...
            <p className="uppercase text-sm text-muted-foreground mb-2">
              IN NO EVENT WILL <strong>WikiSubmission</strong> BE LIABLE TO YOU
              OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL,
              EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR
              IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT
              INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE
              SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT,
              TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED
              OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY
              OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND
              UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU
              PAID TO <strong>WikiSubmission</strong>. THIS SECTION WILL BE
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              appropriate circumstances and, at our sole discretion, access to
              the service for users who are deemed to be repeat infringers.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              courts of the <strong>Utah</strong> and you further agree and
              expressly consent to the exercise of personal jurisdiction in the
              courts of the <strong>Utah</strong> located in{' '}
              <strong>Salt Lake City</strong> in connection with any such
              dispute including any claim involving Service. You further agree
              that you and Service will not commence against the other a class
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <strong>WikiSubmission</strong> relating to your use of the
              Service.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              these Terms and, in general, <strong>WikiSubmission</strong>, you
