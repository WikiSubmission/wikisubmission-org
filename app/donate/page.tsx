...
export default function DonatePage() {
    return (
        <main className="flex flex-col min-h-screen items-center justify-center text-center space-y-4 md:p-24 p-8">
            ...
            <section className="max-w-sm text-center text-sm text-muted-foreground space-y-3">
                <p>
                    <b>Your donations directly support our cause.</b> Funds are allocated on a priority basis, with a primary focus on maintaining existing infrastructure and operations, and any excess towards new technical and creative works in the cause of God.
                </p>

                <p>
                    <b>Donations do not purchase, unlock, or provide any in‑app features or content.</b>
                </p>
            </section>
