  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-center text-center space-y-4 md:p-24 p-8">
      ...
      <section className="max-w-sm flex gap-4 max-w-md items-center">
        <h1 className="text-3xl font-semibold">Support WikiSubmission</h1>
      </section>
      ...
      <section className="max-w-sm flex flex-col gap-4 w-full">
        <Item asChild variant="outline">
          ...
          >
            <ItemContent>
              ...
              <ItemTitle>One-Time Contribution</ItemTitle>
              <ItemDescription>Make a single contribution</ItemDescription>
        ...
        <Item asChild variant="outline">
          ...
          >
            <ItemContent>
              <FaStripe className="size-6" />
              <ItemTitle>Monthly Contribution</ItemTitle>
              <ItemDescription>
        ...
        <Item asChild variant="outline">
          ...
          >
            <ItemContent>
              ...
              <ItemTitle>PayPal Giving Fund</ItemTitle>
              <ItemDescription>
        ...
        <Item asChild variant="outline">
          ...
          >
            <ItemContent>
              ...
              <ItemTitle>GoFundMe</ItemTitle>
              <ItemDescription>Donate through GoFundMe</ItemDescription>
            </ItemContent>
            <ItemActions>
              <Gift className="size-5" />
              <ChevronRight className="size-4" />
      ...
      <section className="max-w-sm text-center text-sm text-muted-foreground space-y-3 ">
        <p>
          WikiSubmission is a registered 501(c)(3) public charity (EIN:
          39-4876245). Donations are fully tax-deductible to the extent
          permitted by law.
        </p>
      </section>
      ...
      <section className="max-w-sm text-center text-sm text-muted-foreground space-y-3">
        <p>
          <b>Your donations directly support our cause.</b> Funds are allocated
          on a priority basis, with a primary focus on maintaining existing
          infrastructure and operations, and any excess towards new technical
          and creative works in the cause of God.
        </p>

        <p>
          <b>
            Donations do not purchase, unlock, or provide any in‑app features or
            content.
          </b>
        </p>
      </section>
      ...
      <section className="max-w-sm text-center text-sm text-muted-foreground space-y-3">
        <p>
          To manage your monthly contribution, or to update your billing
      ...
      <section className="max-w-sm text-center italic text-sm text-muted-foreground border-y border-muted-foreground/20 py-4 space-y-4">
        <p>
          <strong>[2:261]</strong> The example of those who spend their monies
          in the cause of GOD is that of a grain that produces seven spikes,
          with a hundred grains in each spike. GOD multiplies this manifold for
          whomever He wills. GOD is Bounteous, Knower.
        </p>

        <p className={`text-lg text-center ${Fonts.amiri.className}`}>
          مَّثَلُ ٱلَّذِينَ يُنفِقُونَ أَمْوَٰلَهُمْ فِى سَبِيلِ ٱللَّهِ
          كَمَثَلِ حَبَّةٍ أَنۢبَتَتْ سَبْعَ سَنَابِلَ فِى كُلِّ سُنۢبُلَةٍ
          مِّا۟ئَةُ حَبَّةٍ وَٱللَّهُ يُضَٰعِفُ لِمَن يَشَآءُ وَٱللَّهُ وَٰسِعٌ
          عَلِيمٌ
        </p>
      </section>
