            ...
            <div className="hidden md:flex items-center justify-end gap-1 pr-6 min-w-[220px]">
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  side="top"
                  className="w-56 p-2 bg-background/95 backdrop-blur-xl border-border/50 shadow-2xl"
                >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  side="top"
                  align="center"
                  className="w-12 py-4 flex flex-col items-center gap-3 bg-background/95 backdrop-blur-xl border-border/50 shadow-2xl"
                >
                  <div className="h-24">
                    <Slider
                      value={[volume * 100]}
