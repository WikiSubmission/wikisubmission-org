    ...
    return (
        <div className="space-y-2 bg-muted/50 rounded-2xl p-4">
            <div className="flex justify-between items-center">
                ...
                <Link href={`/quran/${verse.chapter_number}?verse=${verse.verse_number}&word=${verse.word_index}`} target="_blank" className="hover:cursor-pointer text-violet-500 border border-violet-500 rounded-full p-1">
