  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 pointer-events-none mb-4">
      <div className="max-w-5xl mx-auto pointer-events-auto">
        ...
        <div className="bg-background/80 backdrop-blur-xl border border-border shadow-2xl rounded-2xl overflow-hidden transition-all duration-300 md:h-20">
              ...
              <div className="hidden md:flex items-center justify-end gap-2 md:w-1/3">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    side="top"
                    align="center"
                    className="w-12 py-4 flex flex-col items-center gap-3"
                  >
                    <div className="h-32">
                      <Slider
                        value={[volume * 100]}
      ...
      <Sheet open={isQueueOpen} onOpenChange={setIsQueueOpen}>
        <SheetContent
          side="right"
          className="w-full sm:max-w-md p-0 border-l border-border bg-background flex flex-col"
        >
